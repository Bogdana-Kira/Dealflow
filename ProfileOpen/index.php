    ...
    <div class="profile">
      <div class="div">
        <div class="overlap">
          ...
          <a href="/html/Favorites/index.html"><img class="frame" src="img/frame-70.svg" /></a>
          <div class="frame-2">
            <img class="iconsax-linear-2" src="img/iconsax-linear-category2.svg" />
        ...
        <div class="frame-6">
          <img class="img-2" src="img/vuesax-linear-profile-2.svg" />
        </div>
        <div class="frame-7"><a href = "/html/History/index.html">
          <div class="text-wrapper-15">My orders</div>
          <img class="img-2" src="img/vuesax-linear-task-square.svg" /></a>
        </div>
        <div class="frame-8"><a href = "/html/Favorites/index.html">
          <div class="text-wrapper-15">Favorites</div>
          <img class="img-2" src="img/iconsax-linear-heart.svg" /></a>
        </div>
        <div class="frame-9">
          <div class="text-wrapper-15">Viewed items</div>
          <img class="img-2" src="img/shownhide-button.svg" />
        </div>
        <div class="frame-10">
          <div class="text-wrapper-15">Mailings</div>
          <img class="img-2" src="img/vuesax-linear-notification.svg" />
        </div>
        <div class="frame-11">
          <div class="text-wrapper-15">My wallet</div>
          <img class="img-2" src="img/vuesax-linear-card.svg" />
        </div>
        <div class="frame-12">
          <div class="text-wrapper-15">Bonus account</div>
          <img class="img-2" src="img/vuesax-linear-empty-wallet.svg" />
        </div>
        <div class="frame-13">
          <div class="text-wrapper-15">My feedback</div>
          <img class="img-2" src="img/vuesax-linear-message-2.svg" />
        </div>
        <div class="frame-14">
          <div class="text-wrapper-15">Direct with sellers</div>
          <img class="img-2" src="img/vuesax-linear-messages.svg" />
        </div>
        <div class="frame-15">
          <div class="text-wrapper-15">My measurements</div>
          <img class="img-2" src="img/vuesax-linear-ruler.svg" />
        </div>
        ...
        <div class="overlap-wrapper">
          <div class="overlap-2">
            ...
            <img class="frame-16" src="img/frame-83.png" />
          </div>
        </div>
        <div class="frame-17">
          <img class="vuesax-linear-3" src="img/vuesax-linear-profile.svg" />
        ...
        <div class="frame-19">
          ...
          <img class="img-3" src="img/vuesax-linear-call.svg" />
        </div>
        <div class="frame-20">
          <div class="text-wrapper-21">Shipping address</div>
          <img class="img-3" src="img/vuesax-linear-group.svg" />
        </div>
        <div class="frame-21">
          <div class="text-wrapper-21">Log in</div>
          <img class="img-3" src="img/vuesax-linear-lock.svg" />
        </div>
        <div class="frame-22">
          <div class="text-wrapper-21">Additional information</div>
          <img class="img-3" src="img/vuesax-linear-user-add.svg" />
        </div>
        <div class="frame-23">
          <div class="text-wrapper-21">Hobbies</div>
          <img class="img-3" src="img/vuesax-linear-smileys.svg" />
        </div>
        <div class="frame-24">
          <div class="text-wrapper-21">Pets</div>
          <img class="img-3" src="img/vuesax-linear-pet.svg" />
        </div>
