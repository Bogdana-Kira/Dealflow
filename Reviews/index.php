    ...
    <div class="reviews">
      <div class="div">
        <div class="overlap">
          ...
          <img class="frame" src="img/frame-70.svg" />
          <div class="frame-2">
          ...
          <div class="frame-4">
            <div class="item-card">
              <div class="overlap-group-3">
                <div class="card">
                  <div class="preview"><img class="image" src="img/<?= $similar[0]['ImageURL'] ?>" /></div>
                ...
                <div class="cart"><img class="img-2" src="img/vuesax-linear-shopping-cart-1.svg" /></div>
                <img class="like-button" src="img/likebutton-1.svg" />
            ...
            <div class="item-card">
              <div class="overlap-group-3">
                <div class="card">
                  <div class="preview"><img class="image-2" src="img/<?= $similar[3]['ImageURL'] ?>" /></div>
            ...
            <div class="item-card">
              <div class="overlap-group-3">
                <div class="card">
                  <div class="preview"><img class="image" src="img/<?= $similar[4]['ImageURL'] ?>" /></div>
            ...
            <div class="item-card">
              <div class="overlap-group-3">
                <div class="card">
                  <div class="preview"><img class="image" src="img/<?= $similar[2]['ImageURL'] ?>" /></div>
            ...
            <div class="item-card">
              <div class="overlap-group-3">
                <div class="card">
                  <div class="preview"><img class="image" src="img/<?= $similar[1]['ImageURL'] ?>" /></div>
        ...
        <img class="vuesax-linear-home" src="img/vuesax-linear-home-2-1.svg" />
        <img class="line" src="img/line-4.svg" />
        <div class="text-wrapper-12"><a href="/html/3html/index.html">All about product</a></div>
        <div class="text-wrapper-13"><a href="/html/Features/index.html">Features</a></div>
        <div class="text-wrapper-14">Reviews</div>
        <div class="text-wrapper-15"><a href="/html/Questions/index.html">Questions</a></div>
        <p class="text-wrapper-16"><?= $product['Model'] ?></p>
        <img class="group-6" src="img/group-111.png" />
        ...
        <div class="frame-5">
          ...
          <img class="iconsax-linear-heart" src="img/iconsax-linear-heart.svg" />
          <div class="frame-6">
            <img class="img-2" src="img/vuesax-linear-shopping-cart-1.svg" />
            <div class="text-wrapper-23">Buy</div>
          </div>
          <img class="vuesax-linear-arrow" src="img/vuesax-linear-arrow-swap-horizontal-1.svg" />
        </div>
        <footer class="FOOTER">
          <div class="f">
            <div class="overlap-group-4">
              ...
              <div class="group-10">
                ...
                <a href="/html/Servise/index.html">
        ...
        <div class="image-wrapper"><img class="image-3" src="img/<?= $product['ImageURL'] ?>" /></div>
        <img class="frame-7" src="img/frame-126.svg" />
        ...
        <div class="frame-11"><img class="vuesax-linear-3" src="img/vuesax-linear-gallery-5.svg" /></div>
        <div class="frame-12"><img class="vuesax-linear-3" src="img/vuesax-linear-gallery-5.svg" /></div>
        <div class="frame-13"><img class="vuesax-linear-3" src="img/vuesax-linear-gallery-5.svg" /></div>
        <div class="frame-14"><img class="vuesax-linear-3" src="img/vuesax-linear-gallery-5.svg" /></div>
        <div class="frame-15"><img class="vuesax-linear-3" src="img/vuesax-linear-gallery-5.svg" /></div>
        <div class="frame-16"><img class="vuesax-linear-3" src="img/vuesax-linear-gallery-5.svg" /></div>
