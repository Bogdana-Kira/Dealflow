    ...
    <div class="features">
      <div class="div">
        <div class="overlap">
          ...
          <div class="group"><a href="/html/1html/index.html">
          ...
          <img class="frame-2" src="img/frame-70.svg" />
          <div class="frame-3">
          ...
          <div class="frame-4">
            <div class="item-card">
              <div class="overlap-group-3">
                ...
                <div class="cart"><img class="img-2" src="img/vuesax-linear-shopping-cart-6.svg" /></div>
        ...
        <img class="line-5" src="img/line-9.svg" />
        ...
        <div class="frame-5">
          ...
          <div class="frame-6">
            <img class="img-2" src="img/vuesax-linear-shopping-cart-6.svg" />
            <div class="text-wrapper-24">Buy</div>
          </div>
          <img class="vuesax-linear-arrow" src="img/vuesax-linear-arrow-swap-horizontal.svg" />
        </div>
        <footer class="FOOTER">
          <div class="f">
            <div class="overlap-group-4">
              ...
              <div class="group-7"><a href="/html/1html/index.html">
        ...
        <div class="image-wrapper"><img class="image-3" src="img/image-1.png" /></div>
        <div class="group-12">
