      ...
      <div class="div">
        <div class="overlap">
          ...
          <div class="group-4"><a href="/html/1html/index.html">
            <img class="LOGO" src="img/logo.svg" /></a>
            <a href="/html/1html/index.html"><div class="frame-wrapper"><img class="frame-3" src="img/frame.svg" /></div>
            </a></div>
        </div>
        <div class="overlap-2">
          <div class="overlap-3">
            ...
            <div class="item-card">
              <div class="overlap-group-3">
                <div class="card">
                  <div class="preview"><img class="image" src="img/<?= $product[3]['ImageURL'] ?>" /></div>
                  <div class="item-name-wrapper">
                    <p class="item-name"><?= $product[3]['Model'] ?></p>
                  </div>
                  <div class="price">
                    <p class="element"><span class="span">$ </span> <span class="text-wrapper-6"><?= $product[3]['Price'] ?></span></p>
                  </div>
                </div>
                <div class="cart"><img class="img-2" src="img/vuesax-linear-shopping-cart-29.svg" /></div>
                <img class="like-button" src="img/likebutton-28.svg" />
            ...
            <div class="overlap-wrapper">
              <div class="overlap-group-3">
                <div class="card">
                  <div class="preview"><img class="image" src="img/<?= $product[0]['ImageURL'] ?>" /></div>
                  <div class="item-name-wrapper">
                    <p class="item-name">
                      <?= $product[0]['Model'] ?>
                    </p>
                  ...
                  <div class="price">
                    <p class="element">
                      <span class="text-wrapper-8">$ </span> <span class="text-wrapper-9"><?= $product[0]['Price'] ?></span>
                    </p>
                  </div>
                </div>
                <div class="cart"><img class="img-2" src="img/vuesax-linear-shopping-cart-29.svg" /></div>
          ...
          <div class="overlap-4">
            <div class="FILTER">
              <div class="overlap-5">
                <div class="overlap-6">
                  <div class="group-wrapper">
                    <div class="group-5">
                      <div class="frame-4">
                        <div class="frame-5">
                          <img class="img-2" src="img/vuesax-linear-quote-up-square-1.svg" />
                ...
                <img class="vuesax-linear-arrow" src="img/vuesax-linear-arrow-up-4.svg" />
              </div>
              <div class="group-6">
                <div class="group-7">
                  <div class="frame-7">
              ...
              <div class="group-11">
                <div class="group-12">
                  <div class="frame-7">
                    <div class="frame-5">
                      <img class="img-2" src="img/group-108-1.png" />
              ...
              <div class="price-2">
                ...
                <div class="group-16">
                  ...
                  <img class="group-17" src="img/group-108.png" />
                </div>
              </div>
              <div class="frame-10"><div class="text-wrapper-16">Reset</div></div>
              <div class="frame-11"><div class="text-wrapper-17">Apply</div></div>
              <img class="vuesax-linear-arrow-2" src="img/vuesax-linear-arrow-up-4.svg" />
              <img class="vuesax-linear-arrow-3" src="img/vuesax-linear-arrow-up.svg" />
              <img class="vuesax-linear-arrow-4" src="img/vuesax-linear-arrow-up.svg" />
              <img class="vuesax-linear-arrow-5" src="img/vuesax-linear-arrow-up.svg" />
            </div>
            <div class="frame-12">
              <div class="item-card-2">
                <div class="overlap-group-3">
                  <div class="card">
                    <div class="preview"><img class="image" src="img/<?= $product[1]['ImageURL'] ?>" /></div>
              ...
              <div class="item-card-2">
                <div class="overlap-group-3">
                  <div class="card">
                    <div class="preview"><img class="image" src="img/<?= $product[2]['ImageURL'] ?>" /></div>
                    <div class="item-name-wrapper">
              ...
              <div class="item-card-2">
                <div class="overlap-group-3"><a href="/html/3html/index.html">
                  <div class="card">
                    <div class="preview"><img class="image" src="img/<?= $product[0]['ImageURL'] ?>" /></div>
                    <div class="item-name-wrapper">
                      <p class="item-name">
              ...
              <div class="item-card-2">
                <div class="overlap-group-3">
                  <div class="card">
                    <div class="preview"><img class="image" src="img/<?= $product[0]['ImageURL'] ?>" /></div>
                    <div class="item-name-wrapper"><div class="item-name"><?= $product[0]['Model'] ?></div></div>
                    <div class="price">
                      <p class="element">
                        <span class="text-wrapper-8">$ </span> <span class="text-wrapper-9"><?= $product[0]['Price'] ?></span>
                      </p>
              ...
              <div class="item-card-2">
                <div class="overlap-group-3">
                  <div class="card">
                    <div class="preview"><img class="image" src="img/<?= $product[0]['ImageURL'] ?>" /></div>
                    <div class="item-name-wrapper">
                      <div class="item-name"><?= $product[0]['Model'] ?></div>
                    </div>
                    <div class="price">
                      <p class="element">
                        <span class="text-wrapper-8">$ </span> <span class="text-wrapper-9"><?= $product[0]['Price'] ?></span>
          ...
          <img class="vuesax-linear-home" src="img/vuesax-linear-home-2.svg" />
          <div class="group-18">
            <div class="img">
            ...
            <img class="vuesax-linear-arrow-6" src="img/vuesax-linear-arrow-right-1.svg" />
          </div>
