    ...
    <div class="history">
      <div class="div">
        <div class="overlap">
          ...
          </a><div class="frame-wrapper"><img class="frame-3" src="img/frame.svg" /></div>
          </div>
        </div>
        <footer class="FOOTER">
          <div class="f">
        ...
        <div class="frame-4">
          <img class="img-2" src="img/vuesax-linear-profile-1.svg" />
          <div class="group-10">
        ...
        <div class="frame-5">
          ...
          <img class="img-2" src="img/vuesax-linear-task-square.svg" />
        </div>
        ...
        <div class="frame-15">
          ...
          <img class="image" src="img/<?= $historyInfo[0]['ImageURL']?>" />
        </div>
        <div class="frame-16">
          <div class="rectangle-4"></div>
          <p class="text-wrapper-15">№ <?= $historyInfo[0]['OrderNumber']?> since <?= date("d.m.y",strtotime($historyInfo[0]['OrderDate']))?></p>
        ...
        <div class="frame-19">
          ...
          <img class="vuesax-linear-arrow" src="img/vuesax-linear-arrow-right-1.svg" />
          <img class="image" src="img/<?= $historyInfo[1]['ImageURL']?>" />
        </div>
        <div class="frame-20">
          <div class="rectangle-5"></div>
          <p class="text-wrapper-15"><?= $historyInfo[1]['OrderNumber']?> since <?= date("d.m.y",strtotime($historyInfo[1]['OrderDate']))?></p>
        ...
        <div class="frame-23">
          ...
          <img class="vuesax-linear-arrow" src="img/vuesax-linear-arrow-right-1.svg" />
          <img class="image" src="img/<?= $historyInfo[2]['ImageURL']?>" />
        </div>
        <div class="frame-24">
          <div class="rectangle-6"></div>
          <p class="text-wrapper-15"><?= $historyInfo[2]['OrderNumber']?> since <?= date("d.m.y",strtotime($historyInfo[2]['OrderDate']))?></p>
